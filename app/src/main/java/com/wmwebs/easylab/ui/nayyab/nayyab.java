package com.wmwebs.easylab.ui.nayyab;
...
public class nayyab extends Fragment {
WebView webView;
    SwipeRefreshLayout swipeRefreshLayout;
    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.fragment_nayyab, container, false);
        webView = root.findViewById(R.id.nayyabwebview);
        swipeRefreshLayout=root.findViewById(R.id.nayyabswiperefreshayout);
...
//faster to load
        ...
        webView.loadUrl("https://easylab.pk/nayab-labs/");
