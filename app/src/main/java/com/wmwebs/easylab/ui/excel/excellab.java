package com.wmwebs.easylab.ui.excel;
...
public class excellab extends Fragment {
WebView webView;
    SwipeRefreshLayout swipeRefreshLayout;
    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.fragment_excel, container, false);
        webView = root.findViewById(R.id.excelwebview);

        swipeRefreshLayout=root.findViewById(R.id.excelswiperefreshayout);
...
//faster to load
        ...
        webView.loadUrl("https://easylab.pk/excel-labs/");
