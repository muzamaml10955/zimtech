package com.wmwebs.easylab.ui.chughtai;
...
public class chughtai extends Fragment {


    String url = "https://easylab.pk/chughtai-lab/";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View root = inflater.inflate(R.layout.fragment_chughtaie, container, false);


        webView = root.findViewById(R.id.advancewebview);
        swipeRefreshLayout = root.findViewById(R.id.advanceswiperefreshayout);
